...
class EmailOTPAuthPage extends StatefulWidget{
  ...
  final bool isMailOtp;
  EmailOTPAuthPage({super.key,required this.mailId,required this.verificationId,required this.emailAuth,required this.isMailOtp});
  @override
...
class _EmailOTPAuthPageState extends State<EmailOTPAuthPage> {
  ...
  void vaidateOTP() {
    String otp = _box1.text+_box2.text+_box3.text+_box4.text+_box5.text+_box6.text;
    bool isValid = widget.emailAuth.validateOtp(
      recipientMail: widget.mailId,
      userOtp: otp
    );
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Text(
                    // "+91 " + widget.maildId[0] + widget.maildId[1] + "********" + widget.maildId[8] + widget.maildId[9],
                    widget.mailId,
