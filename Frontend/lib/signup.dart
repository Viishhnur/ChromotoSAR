...
import 'package:login_page/phoneLogin.dart';
...
class _SignUpPageState extends State<SignUpPage> {
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
            builder: (context) => EmailOTPPage(
                mailId: _email.text.toString(), username:_username.text.toString(),password: _passwd.text.toString(),pickedImage: pickedImage!,isEmailOtp: true,generatedMobileOtp: "",)),
      );
  ...
  void signUp(BuildContext context, String email, String passwd,
      String confirmPasswd) async {
    if (email == "" && passwd == "") {
      Uihelper.CustomDialogBox(
          context, "Error", "Please enter your email and password", false,false,false);
      ...
      developer.log("Username: $email, Password: $passwd");
            ...
            child: Column(
              ...
              children: [
                ...
                InkWell(
                  ...
                  onTap: () {
                    developer.log("phone number register tapped");
                    Navigator.push(
                      context,
                ...
                Uihelper.CustomTextField(
                    _email, "Email", "Email", Icons.mail, false, false,false, () {}),
                  ...
                  children: [
                    SquareTile(
                      onTap: () async {
                        ...
                        //   Uihelper.CustomDialogBox(
                        //       context, "Error", "Google sign-in failed", false);
                        // }
                      },
